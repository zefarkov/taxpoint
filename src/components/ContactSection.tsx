      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-center lg:px-8">
        ...
        <div className="rounded-lg border border-navy-100 bg-white p-6 shadow-soft">
          <div className="grid gap-5 sm:grid-cols-2">
            <div>
              <p className="text-sm font-semibold text-slate-500">Telefonlar</p>
              <div className="mt-3 grid gap-2">
                {phoneNumbers.map((phone) => (
                  <a
                    key={phone.href}
                    href={phone.href}
                    className="rounded-md border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-semibold text-navy-900 transition hover:border-electric-500 hover:bg-white"
                  >
                    {phone.label}
                  </a>
                ))}
            ...
            <div>
              <p className="text-sm font-semibold text-slate-500">Manzil</p>
              ...
              <div className="mt-3 grid gap-2">
                <a
                  href={googleMapsUrl}
                  className="rounded-md border border-slate-300 bg-white px-4 py-3 text-sm font-semibold text-navy-900 transition hover:border-electric-500 hover:bg-navy-50"
                >
                  Google Maps
                </a>
                <a
